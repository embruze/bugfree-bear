...
**In this case I would probably keep the variable categorical. If you dichotomize the variable you're loosing the dose-response effect. It might be hard for people to remember how much alcohol they consume on average a day exactly, but could probably put themselves in an appropriate category.** 
...
**In this case it probably makes sense to keep them separate. The ORs are not similar - unordered polytomous logistic regression would be appropriate.** 
...
**I would report the crude OR and the specific ORs for the community and hospital groups.** 
...
**The ORs are not similar so unordered polytomous logistic regression would be appropriate.**
...
**Again, I would report the crude and adjusted ORs.** 
